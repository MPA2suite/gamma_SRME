...
# EDITABLE CONFIG
model_name = "SevenNet-mf-ompa-omat24"
checkpoint = "7net-mf-ompa"

torch.set_num_threads(12)  # Set number of threads for PyTorch

device = "cpu"  # "cuda" if torch.cuda.is_available() else "cpu"
calc = SevenNetCalculator(model=checkpoint, device=device, modal="omat24")
